  ...
  return (
    <div className="relative w-full h-px overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, oklch(0.62 0.19 260), oklch(0.82 0.11 220), transparent)",
          filter: "blur(0.5px)",
        }}
      />
      {/* particle trail */}
      {[0, 1, 2].map((i) => (
        <span
          key={i}
          className="absolute top-1/2 -translate-y-1/2 h-1 w-1 rounded-full bg-electric"
          style={{
